pub contract FavoriteNBAPlayer {
    ...
    pub fun createPlayer(firstName: String, lastName: String, number: Int, team: String): @NBAPlayer {
        let player: @NBAPlayer <- create NBAPlayer(_firstName: firstName, _lastName: lastName, _number: number, _team: team)
        return <- player
    }
